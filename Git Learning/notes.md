...
- Pushing the changes to their own branch instead of to the m master branch (so there’s no overlap in coding from feature a branch in feature b commit) 
